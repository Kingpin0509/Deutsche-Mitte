$(document).ready(function () {
    ...
    function init_template() {
        ...
        function animation_settings() {
            ...
            sr.reveal('.animate-time-250', {
                duration: 250
            });
            sr.reveal('.animate-time-500', {
                duration: 500
            });
            sr.reveal('.animate-time-750', {
                duration: 750
            });
            sr.reveal('.animate-time-1000', {
                duration: 1000
            });
            sr.reveal('.animate-time-1250', {
                duration: 1250
            });
            sr.reveal('.animate-time-1500', {
                duration: 1500
            });
            sr.reveal('.animate-time-1750', {
                duration: 1750
            });
        ...
        $(function () {
            $('.countdown-class').countdown({
                date: "September 17, 2017 10:00:00"
            });
        });
