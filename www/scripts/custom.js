$(document).ready(function () {
    function init_template(){ 
        ...
        var scroll_animations = 2; //1 = Auatomatic //2 = Disabled //3 = Manual Classes
...
//        };
        ...
        if(scroll_animations == 1){
            animation_settings();
            //Top Animations
            sr.reveal('.page-content-scroll, .heading-strip h3, .heading-block h4',{origin:'top',   distance:'100%', easing:'cubic-bezier(0.1, 0.2, 0.1, 1)'  });
            //Bottom Animations
            ...
            //Fade Animations
            sr.reveal('.back, .footer-socials, .footer p',  {origin:'top',   easing:'ease-in-out'  });
        }
