 ...
 * Check the [email protected] ngAnimate.$animateCss#usage animation code above} to see how this works.
 *
 ...
 * ([email protected] ngAnimate#css-staggering-animations Click here to learn how CSS-based staggering works in ngAnimate.})
 ...
 * | Animation                        | Occurs                               |
 * |----------------------------------|--------------------------------------|
 * | [email protected] ng.$animate#enter enter}  | when the new element is inserted to the DOM  |
 * | [email protected] ng.$animate#leave leave}  | when the old element is removed from the DOM |
 *
 * @example
    ...
    function($animate, $rootScope) {
      return {
        ...
        link: function(scope, $element, attrs, ctrl, $transclude) {
          ...
          scope.$watchCollection(attrs.ngAnimateSwap || attrs["for"], function(
            value
          ) {
            if (previousElement) {
 ...
 * |----------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|
 * | [email protected] ng.directive:ngRepeat#animations ngRepeat}                                                        | enter, leave and move                                                    |
 * | [email protected] ngRoute.directive:ngView#animations ngView}                                                       | enter and leave                                                          |
 * | [email protected] ng.directive:ngInclude#animations ngInclude}                                                      | enter and leave                                                          |
 * | [email protected] ng.directive:ngSwitch#animations ngSwitch}                                                        | enter and leave                                                          |
 * | [email protected] ng.directive:ngIf#animations ngIf}                                                                | enter and leave                                                          |
 * | [email protected] ng.directive:ngClass#animations ngClass}                                                          | add and remove (the CSS class(es) present)                               |
 * | [email protected] ng.directive:ngShow#animations ngShow} & [email protected] ng.directive:ngHide#animations ngHide}            | add and remove (the ng-hide class value)                                 |
 * | [email protected] ng.directive:form#animation-hooks form} & [email protected] ng.directive:ngModel#animation-hooks ngModel}    | add and remove (dirty, pristine, valid, invalid & all other validations) |
 * | [email protected] module:ngMessages#animations ngMessages}                                                          | add and remove (ng-active & ng-inactive)                                 |
 * | [email protected] module:ngMessages#animations ngMessage}                                                           | enter and leave                                                          |
 *
 ...
 *
 * To learn more about what's possible be sure to visit the [email protected] ngAnimate.$animateCss $animateCss service}.
 *
 ...
 * possible be sure to visit the [email protected] ng.$animate $animate service API page}.
 *
 *
 ...
 *
 * Click here [email protected] ng.$animate to learn more about animations with `$animate`}.
 */
  angular
